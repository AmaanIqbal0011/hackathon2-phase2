...
#     return encoded_jwt
# # Create Async Engine
# # For development, use SQLite to avoid schema conflicts
# DATABASE_URL = "postgresql://neondb_owner:npg_mCBE5xGAs8iK@ep-sweet-salad-ah75xvt2-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
# # if not DATABASE_URL:
